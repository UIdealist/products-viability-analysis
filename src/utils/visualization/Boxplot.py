...
class BoxPlot:
    def __init__(
        ...
        self.mode : BoxplotMode = BoxplotMode.SINGLE
        self.plotter : BoxMatrixPlot = None

    def prepare_matrix_show(
        self, title = "",
    ):
        self.mode : BoxplotMode = BoxplotMode.MATRIX
        self.plotter = BoxMatrixPlot(title)

    def prepare_single_show(
        self, title = ""
    ):
        self.mode : BoxplotMode = BoxplotMode.SINGLE
        self.plotter = BoxSinglePlot(title)
